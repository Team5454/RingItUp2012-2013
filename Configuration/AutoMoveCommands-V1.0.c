...
#define OUR_CPR 1440  //2880 // Encoder Clicks per rotation
...
// Wheel_radius
// Angle to turn
int compute_click_for_two_wheelturn(float wheel_base_distance, float angle)
{
...
void turn_left (float rangle, int tstop, int lspeed, int rspeed)
{
	...
	clicks_to_move = compute_click_for_two_wheelturn(Wheel_Base, rangle);
