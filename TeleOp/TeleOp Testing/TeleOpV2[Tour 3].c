...
task main()
{
	...
	while(true)
	{
		...
		int elevatorAEncVal = nMotorEncoder[elevatorA];
		int elevatorBEncVal = nMotorEncoder[elevatorB];

		nxtDisplayTextLine(3, "Enc A: %d",  elevatorAEncVal);
		nxtDisplayTextLine(4, "Enc B: %d",  elevatorBEncVal);
