...
void initializeRobot()
{
  ...
  servo[rightServo] = 172;  // Old 178 --> 165, 168
  servo[leftServo] = 80;    // Old 75 --> 85, 82, 84, 82,80
...
// //    mode2 = (int)(data & 0b00000111);
    // proto.leftSwitch = (int)(data & 00010000) >> 4;
    // proto.rightSwitch = (int)(data & 00100000) >> 5;
...
// void grab_crate()
// {
// //  const int TIMEOUT = 200; // 3 seconds?
// //  bool moved_too_far = false;
  // int counter = 0;
  // //nMotorEncoder[crateArm] = 0;
 ...
 // motor[crateArm] = -17;
  ...
  // wait1Msec(1000);
     ...
     // wait1Msec(300);
    // time1[T1] = 0;
    // while(nMotorEncoder[crateArm] > -600 && time1[T1] < 400000)
    // {
      // motor[crateArm] = -20;
    ...
    // }
      // motor[crateArm] = 0;
      // wait1Msec(2000);
    // while(nMotorEncoder[crateArm] < -580)
    // {
      // motor[crateArm] = 100;
    // }
  // motor[crateArm] = 0;
     ...
     // counter++;
    // // moved_too_far = nMotorEncoder[crateArm] < -100 // some magic number of ticks
  // //}
  // motor[crateArm] = 0;
// }

// void raise_crate(int height)
// {
  // const int TIMEOUT = 3000; //4 seconds?
  // bool high_enough = false;
  // int counter = 0;
  // nMotorEncoder[crateArm] = 0;
  // while( !high_enough || counter > TIMEOUT)
  // {
    // motor[crateArm] = 90;
    // wait1Msec(1);
    // counter++;
    // high_enough = nMotorEncoder[crateArm] > height;
  // }
// }
