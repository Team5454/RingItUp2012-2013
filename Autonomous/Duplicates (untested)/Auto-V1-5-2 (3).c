...
#pragma config(Servo,  srvo_S1_C4_4,    colorSensorServo,     tServoNone)
...
int colorServoDefault = 90;
int colorServoDown = 180;
int WAMrightServoStart = 125;	// WAM Left Servo Start Point
int WAMleftServoStart = 103;	// WAM Left Servo Start Point
int colorSensorServo = colorServoDefault; //initializes color sensor servo
...
task main()
{
	...
	if(servo[colorSensorServo > colorServoDown) // inequality symbol may be wrong
