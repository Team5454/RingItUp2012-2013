...
#pragma config(Motor,  motorA,          RAMone,        tmotorNXT, openLoop, reversed)
#pragma config(Motor,  motorB,          RAMtwo,        tmotorNXT, openLoop)
...
#pragma config(Servo,  srvo_S1_C3_3,    stopLeft,             tServoStandard)
#pragma config(Servo,  srvo_S1_C3_4,    stopRight,            tServoStandard)
