...
void selectAutoActions()
{
	...
	while(true)
	{
		...
		nxtDisplayCenteredTextLine(4,"Auto Options:");
		//------------------------------------------------
		...
		if (AutoActions > 4) AutoActions = 4;
		...
		case 2: nxtDisplayCenteredTextLine(6, "Column A");break;
		case 3: nxtDisplayCenteredTextLine(6, "Column B");break;
		case 4: nxtDisplayCenteredTextLine(6, "Column C");break;
...
task main()
{
	...
	// User selected Autonomous Task
	{
		// Get Autononmous actions selected by the driveteam
		selectAutoActions(); // run the select program function
		switch(AutoActions)  // reads the value that the Program integer was left as after the fiunction ran and then runs the other selection functions accordingly
		{
	...
	case 1:	// delay start = 1 second
		delayAutoStartValue = 1;
	case 2:	// delay start = 5 seconds
		delayAutoStartValue = 5;
		break;
	case 3:	// delay start = 10 seconds
		delayAutoStartValue = 10;
		break;
	case 5:	// delay start = 15 seconds
		delayAutoStartValue = 15;
		break;
	...
	case 1:	// Score Ring on the column designated by the IR Beacon
		PlaySound(soundBlip);
		wait1Msec(delayAutoStartValue*1000);
		move_forward(24, 20000, 50, 50);
		break;
	case 2:	// Score Ring on Column A
		wait1Msec(delayAutoStartValue*1000);
		break;
	case 3:	// Score Ring on Column B
		wait1Msec(delayAutoStartValue*1000);
		break;
	case 4:	// Score Ring on Column C
		wait1Msec(delayAutoStartValue*1000);
		break;
	default:	// Not a valad autonomous action
		break;
	}
