...
#pragma config(Servo,  srvo_S1_C4_1,    WAMLeftServo,         tServoNone)
#pragma config(Servo,  srvo_S1_C4_2,    WAMRightServo,        tServoContinuousRotation)
...
task main()
{
	...
	while(true)
	{
		...
		//WAM right up
		if(joy1Btn(8))
			servoTarget[WAMRightServo] = 87;
		//WAM right down
		else if(joy1Btn(6))
			servoTarget[WAMRightServo] = 167;
		else
		...
		//WAM left up
		if(joy1Btn(5))
			servoTarget[WAMLeftServo] = 87;
		//WAM left down
		else if(joy1Btn(7))
			servoTarget[WAMLeftServo] = 167;
		else
